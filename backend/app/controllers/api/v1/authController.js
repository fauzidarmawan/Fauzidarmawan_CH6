...
module.exports = {
    ...
    async buatadmin(req, res) {
        try {
            ...
            const user = await authService.buatadmin(email, password , name , status , createdBy, updatedBy);
            res.status(201).json({
                status: "OK",
                data: user,
            });
    ...
    async semuauser(req, res){
        try{
            const user = await authService.semuauser();
            res.status(200).json({
                status: "OK",
                data: user.data,
                count: user.count
